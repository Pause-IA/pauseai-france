export default {
	...
	liens_utiles_page: {
		...
		filter_category: 'Category (multi-select)',
		filter_type: 'Media type (multi-select)',
		count_singular: 'resource',
		count_plural: 'resources',
		count_total: 'of',
		reset: 'Reset',
		updated: 'Updated:',
		empty: 'No resource matches your search.',
		toc_title: 'Sections',
		cta_title: 'Got a resource to suggest?',
		cta_desc:
		...
		mt_org: 'Organization',
		mt_declaration: 'Statement',
		mt_tool: 'Tool',
		mt_site: 'Site',
		mail_subject: 'Resource suggestion for /ressources',
		mail_body_intro: 'Hello,',
		mail_body_line1: 'I would like to suggest the following resource for the /ressources page:',
		mail_body_title: '- Title: ',
		mail_body_url: '- URL: ',
